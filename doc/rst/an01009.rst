...
For example, setting ``XUD_USB_BUS_SPEED`` to ``1`` can be done in the application
...
======================================== =========== ========== ========
Standard, 0.90V, 600 MHz, high-speed USB 200 mW       22 mW     222 mW
...
Low-power, all optimisations, full-speed  73 mW       11 mW      84 mW
======================================== =========== ========== ========
...
Configuration                                           Core Power  I/O Power  Total
======================================================= =========== ========== ========
FS Class 2, no idle optimisation, streaming @ 48kHz     73 mW       11 mW      84 mW
FS Class 2, no idle optimisation, idle (no streaming)   72 mW       10 mW      82 mW
FS Class 2, XUA idle optimisation, idle (no streaming)  64 mW       10 mW      74 mW
...
A further 10 to 13% of ``xcore.ai`` device power may be saved when the device is enumerated, but not streaming, with the addition
