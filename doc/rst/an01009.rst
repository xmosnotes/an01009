...
.. warning::
    ...
    Whilst application note describes steps for reducing power and on a `XK-AUDIO-316-MC`
...
* Disable fast mode in ``XUD_Manager_loop`` by removing the calls to ``set_thread_fast_mode_on``
  and ``set_thread_fast_mode_off``. Then run the XUD thread in high priority mode by adding
  ``-DXUD_PRIORITY_HIGH`` to the ``APP_COMPILER_FLAGS`` in the ``CMakeLists.txt`` file.
...
600/600 MHz, 0.90V       220 mW       22 mW     242 mW
  ...
  9/600 MHz, 0.90V, HP   118 mW       22 mW     140 mW
  9/600 MHz, 0.85V       147 mW       22 mW     169 mW
  9/600 MHz, 0.85V, HP   106 mW       22 mW     128 mW
======================= =========== ========== ========
...
600/600 MHz, 0.90V       216 mW       11 mW     227 mW
  ...
  9/600 MHz, 0.85V, HP   107 mW       11 mW     118 mW
======================= =========== ========== ========
